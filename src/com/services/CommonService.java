...
public class CommonService {
        ...
        list.forEach(personalResume -> {
            ...
            if (file.exists()) {
                try {
                    ...
                    personalResume.setPersonPic(base64.encodeToString(data));//照片以二进制数据写入简历
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public boolean SendFileEmail(String to, String filePath, String subject,
        ...
        String propertiesPath = this.getClass().getClassLoader().getResource("/").getPath() + "com/config/mail.properties";

	...
	<script>
        $(function(){
            ...
            $("#page").blur(function(){
                ...
                var url = "${pageContext.request.contextPath}/findPosition.action?currentPage="+page;
            ...
            $("#endP").click(function(){
                var positionPid = [];
                var url = "${pageContext.request.contextPath}/endPosition.action?currentPage="+page+"&action=endP";
            ...
            $("#delP").click(function(){
                var positionPid = [];
                var url = "${pageContext.request.contextPath}/deletePosition.action?currentPage="+page+"&action=delP";
                $("#result input[type=checkbox]:checked").each(function(){
                    positionPid.push($(this).val());
                });
                $("#positionPid").val(positionPid);
...
<div class="main-content">
    <div class="bar">
        <ul class="nav nav-pills">
            ...
            <li ><a href="${pageContext.request.contextPath}/findOverPosition.action?currentPage=1" target="_self">已经结束</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/findPosition.action?currentPage=1"target="_self">全部职位</a></li>
        </ul>
    </div>
    <form action="" enctype="multipart/form-data" method="post">
        <div class="content">
            <table class="table table-hover ">
                ...
                <tr>
                    ...
                    <td>${position.state == 1 ? "正在招聘中":"已结束招聘"}</td>
                </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <a href="${pageContext.request.contextPath}/findPosition.action?currentPage=1">首页</a>&nbsp;&nbsp;&nbsp;
        <a href="${pageContext.request.contextPath}/findPosition.action?currentPage=${page.totalPage}">尾页</a>&nbsp;&nbsp;&nbsp;

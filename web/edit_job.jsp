...
<div class="main-contain">
    <div class="main">
        <form action="${pageContext.request.contextPath}/addPosition.action" method="post" class="form-horizontal"
              enctype="multipart/form-data" id="perfectForm">
            <div class="title">
                <span>发布职位</span>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="classification" id="classification"
                           placeholder="请填写职能分类" onclick='get()'>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="department" id="department" placeholder="请填写所属部门">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" data-beatpicker="true" data-beatpicker-position="['*','*']"
                           data-beatpicker-module="today,clear" name="deadline" id="deadline"
                           placeholder="请选择截止日期"/>

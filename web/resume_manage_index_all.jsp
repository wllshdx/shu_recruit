    ...
    <div class="nav-contain">
        <div class="nav">
            <ul>
                <!--logo-->
                <!--导航-->
                <li class="nav-right"><a href="${basePath}findPositionByCid.action?state=1&currentPage=1"
                                         style="background-color: #337AB7">简历管理</a></li>
                <li class="nav-right"><a href="${pageContext.request.contextPath}/findOnPosition.action?currentPage=1">职位管理</a>
                </li>
...
<div class="main-content">
    <div class="bar">
        <ul class="nav nav-pills">
            <li><a href="${basePath}findPositionByCid.action?state=1&currentPage=1" target="_self">正在招聘</a></li>
            <li><a href="${basePath}findPositionByCid.action?state=2&currentPage=1" target="_self">已经结束</a></li>
            <li class="active"><a href="${basePath}findPositionByCid.action?state=&currentPage=1"
                                  target="_self">全部职位</a></li>
        </ul>
    </div>
    <form class="form-inline classify">
        <div class="form-group">
            <label for="">所属部门</label>
            <input action="${basePath}findPositionByCid.action" type="text" class="form-control" placeholder="所属部门"
                   name="department" value="${page.position.department}">
        </div>
    ...
    <form action="" enctype="multipart/form-data" method="post">
            ...
            <table class="table table-hover ">
                ...
                <c:forEach items="${list}" var="list">
                    ...
                    <tr>
                        <td><a></a></td>
                        <td>
                            <a href="${basePath}findPositionResume.action?currentPage=1&pid=${list.pid}&state=w">${list.position.position}</a>
                        </td>
        ...
        <div class="page">
            &nbsp;&nbsp;
            <a href="${basePath}findPositionByCid.action?state=&currentPage=1&department=${page.position.department}">首页</a>&nbsp;&nbsp;&nbsp;
            <a href="${basePath}findPositionByCid.action?state=&currentPage=${page.totalPage}&department=${page.position.department}">尾页</a>&nbsp;&nbsp;&nbsp;

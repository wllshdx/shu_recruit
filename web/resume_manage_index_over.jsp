...
<div class="main-content">
    <div class="bar">
        <ul class="nav nav-pills">
            ...
            <li class="active"><a href="${basePath}findPositionByCid.action?state=2&currentPage=1" target="_self">已经结束</a></li>
   ...
   <form class="form-inline classify">
    ...
    <div class="page">
        &nbsp;&nbsp; 
        <a href="${basePath}findPositionByCid.action?state=2&currentPage=1&department=${page.position.department}">首页</a>&nbsp;&nbsp;&nbsp;
        <a href="${basePath}findPositionByCid.action?state=2&currentPage=${page.totalPage}&department=${page.position.department}">尾页</a>&nbsp;&nbsp;&nbsp;

    ...
    <div class="nav-contain">
        <div class="nav">
            <ul>
                ...
                <li class="nav-right"><a href="search_resume.jsp" style="background-color: #286090">找简历</a></li>
...
<div class="main-contain">
    <div class="main">
        ...
        <form action="${basePath}findResume.action" method="post" class="form-horizontal" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <label class="radio-inline">
                        <input type="radio" id="edu_request7" value="5" name="education"> 其他
                    </label>
                </div>
            </div>
        ...
        <form action="${basePath}findResumeById.action" method="post" class="form-horizontal"
              enctype="multipart/form-data" name="form-number" style="display: none;" id="form-number">
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-10">

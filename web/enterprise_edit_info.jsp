...
<header>
    ...
    <div class="head-contain">
        <div class="head">
            ...
            <a href="${pageContext.request.contextPath}/companyInfoFind.action" class="head-right"
               style=" color: #86CFED;">编辑信息</a>
            <!--清除浮动-->
...
<div class="main-contain">
    <div class="main">
        <form action="${pageContext.request.contextPath}/companyInfoUpdate.action" method="post" class="form-horizontal"
            ...
            <div class="form-group">
                ...
                <img src="${pageContext.request.contextPath}/upload/${companyInfo.logo}"
                     style="width: 100px;height: 100px" id="img">
                <label id="logo-tip" class="control-label" style="color:red; display: none">公司logo不能为空</label>
                <label id="logo-tip2" class="control-label"
                       style="color:red; display: none">图片限于bmp,png,gif,jpeg,jpg格式</label>

...
<div class="main-content">
    <div class="bar">
        <ul class="nav nav-pills">
            <li><a href="${pageContext.request.contextPath}/findOnPosition.action?currentPage=1" target="_self">正在招聘</a>
            </li>
            <li class="active"><a href="${pageContext.request.contextPath}/findOverPosition.action?currentPage=1"
